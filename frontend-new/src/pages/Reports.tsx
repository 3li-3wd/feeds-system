            ...
            <div className="flex gap-2 mb-6 overflow-x-auto pb-2">
                {reportTabs.map((tab) => (
                    <button
                        ...
                        className={`flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-medium whitespace-nowrap transition-colors ${activeReport === tab.id ? "bg-primary text-primary-foreground" : "bg-card hover:bg-muted"
                            }`}
                    >
