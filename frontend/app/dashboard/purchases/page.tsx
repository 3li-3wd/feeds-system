...
export default function PurchasesPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const newPurchase = await purchasesApi.addPurchase(purchaseData)

      // Manually add the feed name for display purposes since mock returns it
      const purchaseWithDetails = {
        ...newPurchase,
        feed_name: selectedMaterial?.name || "Unknown",
      } as PurchaseOperation

      setPurchases((prev) => [purchaseWithDetails, ...prev])
